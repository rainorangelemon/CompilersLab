all:
	...
	flex Lex/lexical.l
	mv lex.yy.c Lex
	gcc Mips/mips.c InterCode/optimize.c Lex/main.c Lex/tree.c Syntax/syntax.tab.c Semantics/symbol_table.c Semantics/semantic.c InterCode/intercode.c InterCode/symbol_table_intercodes.c -ll -ly -o parser
